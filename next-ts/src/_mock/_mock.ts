...
export const _mock = {
  ...
  // Image
  image: {
    cover: (index: number) => `/assets/images/IMG_9166.JPG`,
    avatar: (index: number) => `/assets/images/IMG_9166.JPG`,
    travel: (index: number) => `/assets/images/IMG_9166.JPG`,
    company: (index: number) => `/assets/images/IMG_9166.JPG`,
    product: (index: number) => `/assets/images/IMG_9166.JPG`,
    portrait: (index: number) => `/assets/images/IMG_9166.JPG`,
  },
};
