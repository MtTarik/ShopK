...
import {CategoryOption} from "./product-table-toolbar";
...
export default function ProductTableFiltersResult({
  ...
  const handleRemoveCategory = useCallback(
    (categoryToRemove: CategoryOption) => {
      const newValue = filters.categories.filter((item) => item !== categoryToRemove);
